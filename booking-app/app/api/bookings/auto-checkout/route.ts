...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (bookingsSnapshot.empty) {
      console.log("No bookings found with endDate in the last 24 hours and in the past.");
      return NextResponse.json({ message: "No bookings found needing auto-checkout." }, { status: 200 });
    }
